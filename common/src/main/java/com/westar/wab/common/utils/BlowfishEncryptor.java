package com.westar.wab.common.utils;
...
/**
 * Created by WangAnbang on 2016/11/3.
 */
public class BlowfishEncryptor {
    private static final Logger Log = LoggerFactory.getLogger(BlowfishEncryptor.class);

    private BlowfishCBC m_bfish;
    private static Random m_rndGen = new SecureRandom();
    private static final String DEFAULT_KEY = "Nsky@0!6-Wab";
     ...
     */
    public BlowfishEncryptor(String password) {
        setKey(password);
    }
